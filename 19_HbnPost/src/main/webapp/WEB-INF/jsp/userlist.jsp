									...
									<table class="table table-user-information">
										<tbody>
											...
											<tr>
												<td>Actividad</td>
												<td>
													${fn:length(autor.posts)} ${(fn:length(autor.posts) == 1) ? 'artículo ' : 'artículos ' }y 
													${fn:length(autor.comments)} ${(fn:length(autor.comments) == 1) ? 'comentario' : 'comentarios' }
