...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron">
			...
			<p class="lead">Tutoriales, información y tips sobre la mejor
				tecnología de persistencia para Java y .Net</p>
			<c:if test="${empty sessionScope.userLoggedIn}">	
			<p>
				<a class="btn btn-lg btn-success" href="/signup" role="button">Regrístrate</a>
			</p>
			</c:if>
		</div>
